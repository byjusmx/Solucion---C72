...
export default class RideScreen extends Component {
  ...
  getCameraPermissions = async () => {
    ...
    this.setState({
      /*status === "granted" es true cuando se concede el permiso
    ...
    db.collection("bicycles")
      ...
      .then(doc => {
        ...
        if (bike.is_bike_available) {
          ...
          // ToastAndroid.show(
          //   "Has rentado la bicicleta durante la próxima hora. ¡Disfruta el viaje!",
          //   ToastAndroid.SHORT
          // );
          ...
          Alert.alert("Esperamos que hayas disfrutado el viaje");
          this.setState({
            bikeAssigned: false
          });
        }
